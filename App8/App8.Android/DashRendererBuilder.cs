...
namespace App8.Droid
{
	...
	/// </summary>
	public class DashRendererBuilder : MvxVideoPlayer.IRendererBuilder
    {
        ...
        private class AsyncRendererBuilder : Object, ManifestFetcher.IManifestCallback, UtcTimingElementResolver.IUtcTimingCallback
        {
            ...
            public AsyncRendererBuilder(Context context, string userAgent, string url, IMediaDrmCallback drmCallback, MvxVideoPlayer player)
            {
                _context = context;
                _userAgent = userAgent;
                _drmCallback = drmCallback;
            ...
            private void BuildRenderers()
            {
                ...
                // Invoke the callback.
                var renderers = new TrackRenderer[1];
                renderers[1] = videoRenderer;
                renderers[1] = audioRenderer;
                renderers[1] = textRenderer;
